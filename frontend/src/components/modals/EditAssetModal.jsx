...
const STATUS_OPTIONS = ['active', 'under_maintenance', 'disposed', 'sold'];

const EditAssetModal = ({ show, setShow, asset }) => {
	...
	const mutation = useMutation({
		mutationFn: (payload) =>
			axios.patch(`${apiUrl}/assets/${asset._id}`, payload, {
			...
			<div className="transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all font-josefin min-w-[280px] md:min-w-[520px] max-w-lg">
				<div className="p-5 space-y-3">
					<div className="flex justify-between items-start">
						<h2 className="font-semibold text-lg text-blue-500">Edit Asset</h2>
						<button
					...
					<form onSubmit={handleSubmit} className="space-y-3">
						...
						<div>
							<p className="text-sm font-medium text-gray-700 mb-2">Agent / Supplier</p>
							<div className="flex gap-3">
								<div className="flex-1">
