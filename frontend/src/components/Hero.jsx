	...
	return (
		<main className="bg-white relative">
			...
			<div className="relative isolate px-6 pt-14 lg:px-8">
				...
				<div className="w-full pt-4 md:px-5 py-6 md:mt-0 mt-10 mr-auto mb-0 ml-auto space-y-5 sm:py-8 md:py-12 sm:space-y-8 md:space-y-16 max-w-7xl">
						...
						<div className="flex flex-col items-start justify-center w-full h-full pt-6 pr-0 pb-6 pl-0 mb-6 md:mb-0 md:w-1/2">
							<div className="flex flex-col items-start justify-center h-full space-y-3 transform md:pr-10 lg:pr-16 md:space-y-5">
								<h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
									...
									<span className="text-green-900">International Limited </span>
								</h1>
			...
			<section className="py-20 px-4 max-w-7xl mx-auto">
				...
				<div className="grid grid-cols-12 sm:px-5 gap-x-2 md:gap-x-8 gap-y-16">
					{data.map((item, index) => (
						<div
							key={index}
							className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4 rounded-lg hover:-translate-y-1 transition-all duration-300 shadow-sm hover:shadow-lg pb-3 cursor-pointer "
						>
							<img
								src={item.image}
								className="object-cover w-full mb-2 overflow-hidden rounded-t-lg shadow-sm max-h-56 btn-"
							/>
